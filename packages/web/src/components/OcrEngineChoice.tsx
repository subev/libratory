    ...
    <div className="space-y-1.5 text-xs text-(--text-muted)" data-testid="book-ocr-engine">
      ...
      {switching && (
        <span className="block text-(--warning-text)" data-testid="book-ocr-switching">
          You will wait: every page is read again with {value === "surya" ? "Surya, about ten times slower than Tesseract" : "Tesseract"}, and the copy you already have is replaced. Extraction starts after that.
        </span>
      )}
