...
export const POOL_META = [
  ...
  },
  {
    ...
    tasks: ["extract", "redetect", "propose", "ocrTextLayer"],
    default: 1,
    max: 3,
    hint: "Reading one book: OCR for a scan, then layout — minutes to half an hour, several GB of memory, and the GPU. Also runs chapter detection and proposals.",
    cautionAbove: 1,
