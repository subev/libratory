...
- `tasks/ocr-text-layer.md` + `-implementation.md` + `-design-brief.md` + `-design-review.md` — stage 1 (Tesseract, schema, worker, readers) has shipped; the four files stay until stage 2 lands Surya, language-pack downloads and Try One Page
