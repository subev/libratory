...
| 2 | `noUncheckedIndexedAccess` — server | ~~558~~ **done** | |
| 3 | `noUncheckedIndexedAccess` — web | ~~143~~ **done** | flag now lives in `tsconfig.base.json`, covering all four tsconfigs |
| 4 | desktop `checkJs` | ~~29~~ **done** | |
| 5 | CI enforcement | **next** | `.github/workflows/test.yml` — add `pnpm lint` |
